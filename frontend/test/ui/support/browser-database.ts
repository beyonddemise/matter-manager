...
import { type ProjectRepositories, projectRepositories } from '../../../src/data/index.js'
 ...
 * choice of PouchDB build is proved to work at all. `src/data`'s own tests already cover
