...
import { localCatalogue } from '../../../src/ui/db/project-database.js'
import { activateLocale } from '../../../src/ui/i18n/localization.js'
import type { StorageManagerLike } from '../../../src/ui/storage.js'
import {
  DEFAULT_PALETTE,
  DEFAULT_THEME,
  EXCLUDED_THEMES,
...
import type { SettingsView } from '../../../src/ui/views/settings.js'
import '../../../src/ui/views/settings.js'
