 ...
 *
 * Preflights are answered here, before the router, and the limits are keyed on the client
 * address and a fixed bucket — never on the path, which is whatever the client sent.
 */
